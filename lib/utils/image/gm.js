 ...
 */
function scaleImage(base64Screenshot, scaleFactor) {
  var image, percent;
  return _regenerator2.default.async(function scaleImage$(_context2) {
    while (1) {
...
function mergeImages(images) {
  ...
  return _regenerator2.default.async(function mergeImages$(_context3) {
    while (1) {
