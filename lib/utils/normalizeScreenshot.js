    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          viewportSizeMax = Math.max(screenDimensions.getViewportWidth(), screenDimensions.getViewportHeight());
          viewportSizeMin = Math.min(screenDimensions.getViewportWidth(), screenDimensions.getViewportHeight());
...
function normalizeIOSScreenshot(browser, screenDimensions, base64Screenshot) {
  var toolbarHeight, addressbarHeight, isIpad, isIphone, barsShown, barsHeight, width, height, size, deviceInLandscape, screenshotInLandscape, rotation, cropDimensions, croppedBase64Screenshot;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          cropDimensions = new _CropDimension2.default(width, height, 0, barsHeight, true, rotation);
          _context2.next = 17;
